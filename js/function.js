...
var Counter = {
    ...
    Stop: function()
    {
        ...
        localStorage.gettItem("total_score",(this.Score !== "00" && this.Score < 10 ? "0" : "") + this.Score); // this will store the score on browser's local storage
...

{
    ...
    {
        Counter.Initialize(3600); // this is the time limit
